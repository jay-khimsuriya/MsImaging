							...
							<div class="flex-min-height-100vh">
								<div class="padding-top-bottom-150 container small">
									<h2 class="headline-xxl headline-uppercase after-preloader-anim">
										<span class="d-block">
											<span class="anim-chars-fadein" data-splitting>The Best</span>
										</span>
										<span class="d-block" data-scroll data-scroll-speed="-0.4" data-scroll-position="top">
											<span class="anim-chars-fadein" data-splitting>Agency for</span>
										</span>
										<span class="d-block" data-scroll data-scroll-speed="-0.8" data-scroll-position="top">
											<span class="anim-chars-fadein" data-splitting>Your Businnes</span>
										</span>
									</h2>
								</div>
									...
									<div class="column-r-margin-20-999 hidden-box">
										<div data-scroll data-scroll-speed="-1.3">
											<div class="anim-img-reveal" data-scroll data-scroll-offset="20%" style="background-image:url(assets/images/contact/watcharlie-ywUYblWR0tc-unsplash.jpg)">
												<img src="assets/images/contact/watcharlie-ywUYblWR0tc-unsplash.jpg" alt="Contact photo">
											</div>
										</div>
									</div>
								</div><!-- column end -->
											...
											<div class="flex-container">
												...
												<div class="six-columns padding-top-30">
													<div class="column-r-margin-20">
														...
														<div class="margin-top-20">
															...
															<a href="#" class="line-btn text-color-b0b0b0 text-hover-to-white js-pointer-small">mayankpaunikar@gmail.com</a>
														</div>
													</div>
												</div><!-- column end -->
												...
												<div class="six-columns padding-top-30">
													<div class="column-r-margin-20">
														...
														<div class="margin-top-20">
															...
															<a href="#" class="line-btn text-color-b0b0b0 text-hover-to-white js-pointer-small">email@mayank.com</a>
														</div>
													</div>
												</div><!-- column end -->
												...
												<div class="six-columns padding-top-30">
													<div class="column-r-margin-20">
														...
														<div class="margin-top-20">
															<a href="#" class="line-btn text-color-b0b0b0 text-hover-to-white js-pointer-small">email@tumar_career.com</a>
															<div class="margin-top-5">
																<a href="#" class="line-btn text-color-b0b0b0 text-hover-to-white js-pointer-small">paunikarmayank@gmail.com</a>
															</div>
														</div>
													</div>
												</div><!-- column end -->
							...
							<div class="twelve-columns padding-top-120">
								<div class="column-l-r-margin-10 pos-rel">
									<p class="copyright margin-right-30">
										&copy; Copyright 2024 M'S Imaging. Template by 
