				...
				<main class="main-content">
					...
					<section id="up" class="pos-rel hidden-box" data-scroll-section>
						<div class="page-head-footer-overlay-fix" data-scroll data-scroll-repeat>
							<!-- bg-parallax -->
							<div class="bg-parallax" style="background-image:url(assets/images/portfolio/project_04/main.jpg)" data-scroll data-scroll-speed="-1.5"></div>
							...
							<div class="flex-min-height-100vh">
								<div class="padding-top-bottom-120 container text-center after-preloader-anim">
									<h2 class="headline-xxl headline-uppercase anim-chars-fadein" data-splitting>Kei Yamada</h2>
					...
					<section id="down" class="section-bg-dark half-bg-borders-fix half-bg-borders-fix_only-bottom" data-scroll-section>
						...
						<div class="padding-top-bottom-120">
							...
							<div class="container padding-top-120">
								...
								<div class="padding-top-30 padding-bottom-90 pos-rel">
									<!-- anim-line-top -->
									...
									<!-- column start -->
										<div class="four-columns padding-top-60">
											<div class="column-r-margin-20 scrollanim-activate" data-scroll data-scroll-offset="20%">
												<h6 class="headline-xxxs anim-fade-to-left">Strategy</h6>
												<!-- list start -->
												<ul class="list padding-top-20">
													<li class="list__item dot">
														<p class="subhead-xs anim-fade-to-left tr-delay-01">Branding</p>
													</li>
													<li class="list__item dot">
														<p class="subhead-xs anim-fade-to-left tr-delay-02">Creative Concept</p>
													</li>
													<li class="list__item dot">
														<p class="subhead-xs anim-fade-to-left tr-delay-03">Digital identity</p>
													</li>
												</ul><!-- list end -->
											</div>
										</div><!-- column end -->
										...
										<div class="four-columns padding-top-60">
											<div class="column-r-margin-20 scrollanim-activate" data-scroll data-scroll-offset="20%">
												<h6 class="headline-xxxs anim-fade-to-left">Services</h6>
												<!-- list start -->
												<ul class="list padding-top-20">
													<li class="list__item dot">
							...
							<div class="container padding-top-120">
								<div class="scrollanim-activate" data-scroll data-scroll-offset="20%">
									<h3 class="headline-xxs anim-split-lines">IPhone kombucha shaman gastropub</h3>
									<p class="body-text-m text-color-dadada padding-top-20 anim-split-lines">IPhone kombucha shaman gastropub snackwave 90's lo-fi pug chillwave pok pok tofu. Swag deep v listicle roof party seitan man braid raclette church-key trust fund locavore vexillologist green juice raw denim tilde meh. Austin thundercats locavore taiyaki snackwave hoodie put a bird on it tattooed selvage kitsch ramps. Godard slow-carb chartreuse occupy, tumblr letterpress pok pok tattooed yr lyft yuccie kinfolk.</p>
								</div>
					...
					<div class="section-bg-light half-bg-dark" data-scroll-section>
						<a href="assets/images/portfolio/project_04/kei-yamada-6GMwEPZYuhk-unsplash.jpg" class="pos-rel container small d-block hidden-box js-pointer-zoom js-photo-popup">
							<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
								<img class="anim-opacity-scale" src="assets/images/portfolio/project_04/kei-yamada-6GMwEPZYuhk-unsplash.jpg" alt="project image">
							</div>
						</a>
					...
					<div class="section-bg-dark half-bg-light" data-scroll-section>
						<a href="assets/images/portfolio/project_04/kei-yamada-UqBn_5pebzE-unsplash.jpg" class="pos-rel container small d-block hidden-box js-pointer-zoom js-photo-popup">
							<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
								<img class="anim-opacity-scale" src="assets/images/portfolio/project_04/kei-yamada-UqBn_5pebzE-unsplash.jpg" alt="project image">
							</div>
						</a>
					</div><!-- section-bg-dark end -->

					<!-- section-bg-dark start -->
					<section class="section-bg-dark half-bg-borders-fix" data-scroll-section>
						<!-- padding-bottom-120 start -->
						<div class="padding-bottom-120">
							<!-- flex-container start -->
							<div class="container flex-container padding-top-100">
								<!-- column start -->
								<div class="four-columns column-100-999 padding-top-20">
									<h2 class="headline-xxs max-width-300 anim-split-lines" data-scroll data-scroll-offset="30%">Mixtape kinfolk cray, wolf palo santo</h2>
								</div><!-- column end -->
								<!-- column start -->
								<div class="eight-columns column-100-999 padding-top-20">
									<div class="column-l-margin-40-999">
							...
							<div class="container small padding-top-120">
								<a href="assets/images/portfolio/project_04/kei-yamada-R_igeSpeX9A-unsplash.jpg" class="d-block hidden-box js-pointer-zoom js-photo-popup">
									<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
										<img class="anim-opacity-scale" src="assets/images/portfolio/project_04/kei-yamada-R_igeSpeX9A-unsplash.jpg" alt="project image">
									</div>
								</a>
							</div><!-- container end -->
							...
							<!-- container start -->
							<div class="container small padding-top-120">
								<a href="assets/images/portfolio/project_04/kei-yamada-jc-VNQQdg8Y-unsplash.jpg" class="d-block hidden-box js-pointer-zoom js-photo-popup">
									<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
										<img class="anim-opacity-scale" src="assets/images/portfolio/project_04/kei-yamada-jc-VNQQdg8Y-unsplash.jpg" alt="project image">
									</div>
								</a>
							</div><!-- container end -->
					...
					<!-- section-bg-light start -->
					<div class="section-bg-light half-bg-dark" data-scroll-section>
						<a href="assets/images/portfolio/project_04/kei-yamada-TccJrJHNUwA-unsplash.jpg" class="pos-rel container small d-block hidden-box js-pointer-zoom js-photo-popup">
							<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
								<img class="anim-opacity-scale" src="assets/images/portfolio/project_04/kei-yamada-TccJrJHNUwA-unsplash.jpg" alt="project image">
							</div>
						</a>
					</div><!-- section-bg-light end -->
					...
					<section class="section-bg-light half-bg-borders-fix half-bg-borders-fix_only-top" data-scroll-section>
						...
						<div class="flex-min-height-100vh">
							<!-- flex-container start -->
							<div class="container flex-container reverse padding-top-100 padding-bottom-120">
								<!-- column start -->
								<div class="four-columns column-100-999 padding-top-20">
								...
								<div class="eight-columns column-100-999 padding-top-20">
									<div class="column-l-margin-40-999">
										<blockquote class="quote black body-text-m text-color-black">
				...
				<section class="section-bg-dark" data-scroll-section>
					<div class="flex-min-height-100vh pos-rel" data-scroll data-scroll-speed="-4" data-scroll-position="bottom">
						<div class="width-100perc padding-top-bottom-120 pos-rel">
							<a href="project_05.php" class="container small d-block js-pointer-large js-animsition-link">
								<img src="assets/images/portfolio/project_05/main.jpg" alt="project">
							</a>
							<div class="pos-abs pos-center-center width-100perc hidden-box text-color-mix-blend pointer-none">
								<h2 class="marquee headline-xxxl headline-uppercase hidden-box" data-duration="10000" data-gap="20">Curology Curology Curology Curology Curology Curology Curology Curology</h2>
							</div>
						</div>
