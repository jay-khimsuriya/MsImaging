				...
				<main class="main-content">
					...
					<section id="up" class="pos-rel hidden-box" data-scroll-section>
						<div class="page-head-footer-overlay-fix" data-scroll data-scroll-repeat>
							<!-- bg-parallax -->
							<div class="bg-parallax" style="background-image:url(assets/images/portfolio/project_01/main.jpg)" data-scroll data-scroll-speed="-1.5"></div>
							...
							<div class="flex-min-height-100vh">
								<div class="padding-top-bottom-120 container text-center after-preloader-anim">
									<h2 class="headline-xxl headline-uppercase">
										<span class="d-block">
											<span class="anim-chars-fadein" data-splitting>Champion</span>
										</span>
										<span class="d-block" data-scroll data-scroll-speed="-0.4" data-scroll-position="top">
											<span class="anim-chars-fadein" data-splitting>Training</span>
										</span>
									</h2>
						...
						<div class="padding-top-bottom-120">
								...
								<div class="flex-container padding-top-30 padding-bottom-90 pos-rel">
									...
									<div class="four-columns padding-top-60">
										<div class="column-r-margin-20 scrollanim-activate" data-scroll data-scroll-offset="20%">
											<!-- list start -->
											<ul class="list text-color-black anim-fade-to-left">
												<li class="list__item dot black">
													<div class="subhead-xs">Graphic Design</div>
												</li>
												<li class="list__item dot black">
													<div class="subhead-xs">User Interface Design</div>
												</li>
												<li class="list__item dot black">
													<div class="subhead-xs">User Experience Design</div>
												</li>
												<li class="list__item dot black">
													<div class="subhead-xs">Web Design</div>
												</li>
												<li class="list__item dot black">
													<div class="subhead-xs">Motion Design</div>
												</li>
												<li class="list__item dot black">
													<div class="subhead-xs">Front-end Development</div>
												</li>
												<li class="list__item dot black">
													<div class="subhead-xs">Back-end Development</div>
												</li>
											</ul><!-- list end -->
										</div>
									</div><!-- column end -->
									<!-- column start -->
									<div class="eight-columns padding-top-60">
									...
									<div class="four-columns padding-top-60">
										<div class="column-r-margin-20 scrollanim-activate" data-scroll data-scroll-offset="20%">
											<h6 class="headline-xxxxs text-color-black anim-fade-to-left">Platforms</h6>
											<!-- list start -->
											<ul class="list text-color-black padding-top-20">
												<li class="list__item">
													<p class="subhead-xxs anim-fade-to-left tr-delay-01">Mobile</p>
												</li>
												<li class="list__item">
													<p class="subhead-xxs anim-fade-to-left tr-delay-02">Tablet</p>
												</li>
												<li class="list__item">
													<p class="subhead-xxs anim-fade-to-left tr-delay-03">Desktop</p>
												</li>
											</ul><!-- list end -->
										</div>
									</div><!-- column end -->
									...
									<div class="four-columns padding-top-60">
										<div class="column-r-margin-20 scrollanim-activate" data-scroll data-scroll-offset="20%">
											<h6 class="headline-xxxxs text-color-black anim-fade-to-left">Our role</h6>
											<!-- list start -->
											<ul class="list text-color-black padding-top-20">
												<li class="list__item">
							...
							<div class="container flex-container padding-top-60">
								...
								<div class="four-columns column-100-999 padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-_J3X-g-2KKc-unsplash.jpg" class="column-l-r-margin-10-999 d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-_J3X-g-2KKc-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div class="four-columns column-100-999 padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-jKbSIaVcvpI-unsplash.jpg" class="column-l-r-margin-10-999 d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-jKbSIaVcvpI-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div class="four-columns column-100-999 padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-ZiXqi1iSZyI-unsplash.jpg" class="column-l-r-margin-10-999 d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-ZiXqi1iSZyI-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
					...
					<div class="hidden-box" data-scroll-section>
						<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.5">
							<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-Jc-UCKGhIlU-unsplash.jpg" alt="project image">
						</div>
					</div><!-- background end -->
					...
					<section class="section-bg-light" data-scroll-section>
						...
						<div class="padding-top-100">
							...
							<div class="container flex-container">
								...
								<div class="four-columns column-100-999 padding-top-20">
									<div class="column-l-r-margin-10-999">
										<h2 class="headline-xxs text-color-black max-width-300 anim-split-lines" data-scroll data-scroll-offset="30%">Beer bicycle rights man braid trust</h2>
									</div>
								</div><!-- column end -->
							...
							<div class="container small padding-top-60">
								<div class="padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-WO_th3WRJvw-unsplash.jpg" class="d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-WO_th3WRJvw-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div>
								<div class="padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-w6BHqa8ukc0-unsplash.jpg" class="d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-w6BHqa8ukc0-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div>
								<div class="padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-bFCzqCF0wxs-unsplash.jpg" class="d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-bFCzqCF0wxs-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div>
								<div class="padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-w7gfO81HJ8k-unsplash.jpg" class="d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-w7gfO81HJ8k-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div>
							</div><!-- container end -->
						...
						<div class="padding-top-60 padding-bottom-120">
							...
							<div class="container flex-container flex-align-end">
								<!-- columns start -->
								<div class="four-columns column-100-999 padding-top-60">
									<div class="column-l-r-margin-10-999 scrollanim-activate" data-scroll data-scroll-offset="30%">
										<h2 class="headline-xxs text-color-black anim-split-lines">3 wolf moon microdosing scenester</h2>
										<p class="body-text-xs text-color-6d6d6d margin-top-20 anim-split-lines">Mixtape kinfolk cray, wolf palo santo brunch iPhone. Retro jean shorts cronut lumbersexual mixtape hella you probably haven't heard of them austin williamsburg af mustache pinterest. IPhone humblebrag kale chips hell of. Brooklyn whatever chia deep v slow-carb lomo put a bird on. Austin fam chia cold-pressed raw denim. 3 wolf moon microdosing scenester, tilde roof party affogato typewriter celiac echo park craft beer bicycle rights man braid trust fund four dollar toast gentrify.</p>
									</div>
								</div><!-- columns end -->

								<!-- columns start -->
								<div class="eight-columns column-100-999 padding-top-60">
									<a href="assets/images/portfolio/project_01/karsten-winegeart-8RYgfbiTSVU-unsplash.jpg" class="column-l-r-margin-10-999 d-block hidden-box js-pointer-zoom js-photo-popup">
										<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.3">
											<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-8RYgfbiTSVU-unsplash.jpg" alt="project image">
										</div>
									</a>
								</div><!-- columns end -->
							</div><!-- flex-container end -->
					...
					<div class="hidden-box" data-scroll-section>
						<div class="scrollanim-activate" data-scroll data-scroll-speed="-1.5">
							<img class="anim-opacity-scale" src="assets/images/portfolio/project_01/karsten-winegeart-eGSBVVtVCCw-unsplash.jpg" alt="project image">
						</div>
					</div><!-- background end -->
					...
					<section class="section-bg-light" data-scroll-section>
						...
						<div class="flex-min-height-100vh">
							...
							<div class="container small flex-container reverse padding-top-100 padding-bottom-120">
								<!-- column start -->
								<div class="four-columns column-100-999 padding-top-20">
									<h5 class="margin-left-50 scrollanim-activate" data-scroll data-scroll-offset="30%">
										<span class="headline-xxxs text-color-black anim-fade-to-top">Jason Hardeman</span><br>
										<span class="subhead-xxs text-color-black margin-top-5 anim-fade-to-top tr-delay-01">Creative director</span><br>
										<span class="subhead-xxs text-color-black anim-fade-to-top tr-delay-02">XOXO production LTD</span>
									</h5>
								</div><!-- column end -->
				...
				<section class="section-bg-dark" data-scroll-section>
					<div class="flex-min-height-100vh pos-rel" data-scroll data-scroll-speed="-4" data-scroll-position="bottom">
						<div class="width-100perc padding-top-bottom-120 pos-rel">
							<a href="project_02.php" class="container small d-block js-pointer-large js-animsition-link">
								<img src="assets/images/portfolio/project_02/main.jpg" alt="project">
							</a>
							<div class="pos-abs pos-center-center width-100perc hidden-box text-color-mix-blend pointer-none">
								<h2 class="marquee headline-xxxl headline-uppercase hidden-box" data-duration="10000" data-gap="20">Lil Man Lil Man Lil Man Lil Man Lil Man Lil Man Lil Man Lil Man Lil Man Lil Man</h2>
							</div>
						</div>
