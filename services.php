				...
				<main class="main-content">
							...
							<div class="padding-top-bottom-150">
								...
								<div class="container small">
									<h2 class="headline-xxxxl headline-uppercase after-preloader-anim">
										<span class="d-block">
											<span class="anim-chars-fadein" data-splitting>We’r Provided</span>
										</span>
										<span class="d-block" data-scroll data-scroll-speed="-0.4" data-scroll-position="top">
											<span class="anim-chars-fadein" data-splitting>Best Digital</span>
										</span>
										<span class="d-block" data-scroll data-scroll-speed="-0.8" data-scroll-position="top">
											<span class="anim-chars-fadein" data-splitting>Services</span>
										</span>
									</h2>
								</div><!-- title end -->
										...
										<div class="js-services-slider js-pointer-drag" data-scroll data-scroll-speed="2" data-scroll-direction="horizontal">
											...
											<div class="swiper-wrapper">
												...
												<div class="swiper-slide">
													<img src="assets/images/services/thom-bradley-EWUr1JkMZGE-unsplash.jpg" alt="Services">
													<div class="margin-top-20 padding-left-50 pos-rel">
														<div class="subhead-xs pos-abs pos-left-top-0px">01</div>
														<h3 class="headline-xxxs">User Interface Design</h3>
												...
												<!-- swiper-slide start -->
												<div class="swiper-slide">
													<img src="assets/images/services/jon-tyson-i7ZXmllhFfg-unsplash.jpg" alt="Services">
													<div class="margin-top-20 padding-left-50 pos-rel">
														<div class="subhead-xs pos-abs pos-left-top-0px">02</div>
														<h3 class="headline-xxxs">User Experience Design</h3>
												...
												<!-- swiper-slide start -->
												<div class="swiper-slide">
													<img src="assets/images/services/annie-spratt-AkftcHujUmk-unsplash.jpg" alt="Services">
													<div class="margin-top-20 padding-left-50 pos-rel">
														<div class="subhead-xs pos-abs pos-left-top-0px">03</div>
														<h3 class="headline-xxxs">Front-end Development</h3>
												...
												<!-- swiper-slide start -->
												<div class="swiper-slide">
													<img src="assets/images/services/annie-spratt-QckxruozjRg-unsplash.jpg" alt="Services">
													<div class="margin-top-20 padding-left-50 pos-rel">
														<div class="subhead-xs pos-abs pos-left-top-0px">04</div>
														<h3 class="headline-xxxs">Back-end Development</h3>
												...
												<!-- swiper-slide start -->
												<div class="swiper-slide">
													<img src="assets/images/services/vladimir-fedotov--w-V5GRG9-0-unsplash.jpg" alt="Services">
													<div class="margin-top-20 padding-left-50 pos-rel">
														<div class="subhead-xs pos-abs pos-left-top-0px">05</div>
														<h3 class="headline-xxxs">Motion Design</h3>
					...
					<div class="section-bg-light" data-scroll-section>
						...
						<div class="padding-top-bottom-30">
								...
								<div class="js-infinite-slider hidden-box pos-rel padding-top-bottom-60">
									...
									<div class="swiper-wrapper">
										...
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/c.png" alt="logo">
										</div><!-- swiper-slide end -->

										<!-- swiper-slide start -->
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/css.png" alt="logo">
										</div><!-- swiper-slide end -->

										<!-- swiper-slide start -->
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/java.png" alt="logo">
										</div><!-- swiper-slide end -->

										<!-- swiper-slide start -->
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/js.png" alt="logo">
										</div><!-- swiper-slide end -->

										<!-- swiper-slide start -->
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/mysql.png" alt="logo">
										</div><!-- swiper-slide end -->

										<!-- swiper-slide start -->
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/php.png" alt="logo">
										</div><!-- swiper-slide end -->

										<!-- swiper-slide start -->
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/html.png" alt="logo">
										</div><!-- swiper-slide end -->

										<!-- swiper-slide start -->
										<div class="swiper-slide text-center">
											<img class="client-logo" src="assets/images/skills/wp.png" alt="logo">
										</div><!-- swiper-slide end -->
									</div><!-- swiper-wrapper end -->
							...
							<!-- pricing start -->
							<section class="container small padding-top-bottom-120">
								<h2 class="headline-xxxl text-color-black anim-split-lines" data-scroll data-scroll-offset="20%">Our Pricing</h2>

								<!-- flex-container start -->
								<div class="flex-container flex-justify-center">
									<!-- column start -->
									<div class="four-columns column-50-999 padding-top-90">
										<div class="column-l-r-margin-10 price-border black border-radius-10px">
											<div class="text-center">
												<h3 class="headline-xxxxs text-color-black headline-uppercase padding-top-bottom-20">Basic</h3>
											</div>
											<h4 class="text-center padding-top-bottom-40 price-title-border black">
												<span class="headline-l text-color-black">$100</span><br>
												<span class="subhead-s text-color-black">Per month</span>
											</h4>
											<!-- list start -->
											<ul class="list list_center list_margin-20px text-color-6d6d6d subhead-xs margin-left-right-20 padding-top-bottom-60">
												<li class="list__item check black">
													<p>Copper mug</p>
												</li>
												<li class="list__item check black">
													<p>Vexillologist +1</p>
												...
												<li class="list__item x opacity-05 black">
													<p>Vinyl snackwave</p>
												</li>
												<li class="list__item x opacity-05 black">
													<p>XOXO drinking</p>
											...
											<div class="text-center padding-bottom-60">
												<a href="#" class="border-btn black js-pointer-large">
													<span class="border-btn__inner">sign up</span>
									...
									<div class="four-columns column-50-999 padding-top-90">
										<div class="column-l-r-margin-10 price-border black border-radius-10px">
											<div class="text-center">
												<h3 class="headline-xxxxs text-color-black headline-uppercase padding-top-bottom-20">Standard</h3>
											</div>
											<h4 class="text-center padding-top-bottom-40 price-title-border black">
												<span class="headline-l text-color-black">$120</span><br>
												<span class="subhead-s text-color-black">Per month</span>
											</h4>
											<!-- list start -->
											<ul class="list list_center list_margin-20px text-color-6d6d6d subhead-xs margin-left-right-20 padding-top-bottom-60">
									...
									<div class="four-columns column-50-999 padding-top-90">
										<div class="column-l-r-margin-10 price-border black border-radius-10px">
											<div class="text-center">
												<h3 class="headline-xxxxs text-color-black headline-uppercase padding-top-bottom-20">Extended</h3>
											</div>
											<h4 class="text-center padding-top-bottom-40 price-title-border black">
												<span class="headline-l text-color-black">$150</span><br>
												<span class="subhead-s text-color-black">Per month</span>
											</h4>
											<!-- list start -->
											<ul class="list list_center list_margin-20px text-color-6d6d6d subhead-xs margin-left-right-20 padding-top-bottom-60">
