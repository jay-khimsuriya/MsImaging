	...
	<body class="preloader cursor-anim-enable">
		...
		<div id="js-scroll-content">
			...
			<div class="js-animsition-overlay" data-animsition-overlay="true">
					...
					<section id="up" class="section-bg-dark" data-scroll-section>
						...
						<div class="padding-top-120 padding-bottom-150">
							...
							<div class="js-isotope-grid-box container full">
								...
								<!-- grid-item start -->
								<div class="padding-top-90 grid-item-33-50-100 js-isotope-grid-item">
									<a href="project_02.php" class="grid-margin-box d-block js-pointer-large js-animsition-link" data-scroll data-scroll-speed="0.3">
										<!-- project img start -->
										...
										<div class="padding-top-bottom-20 pos-rel scrollanim-activate line-scrollanim-activate" data-scroll data-scroll-offset="30%">
											<div class="anim-fade-to-left d-block">
												<h3 class="headline-xxxs">Lil Man</h3>
												<div class="d-flex flex-wrap flex-justify-between margin-top-10">
													<span class="subhead-xxs subhead-uppercase margin-top-10">Photoshoot</span>
													<span class="subhead-xxs subhead-uppercase margin-top-10">2020</span>
												</div>
											</div>
								...
								<!-- grid-item start -->
								<div class="padding-top-90 grid-item-33-50-100 js-isotope-grid-item">
									<a href="project_01.php" class="grid-margin-box d-block js-pointer-large js-animsition-link" data-scroll data-scroll-speed="0.6">
										<!-- project img start -->
										<div class="hidden-box">
											<div data-scroll data-scroll-speed="-1.3">
												<div class="anim-img-reveal" data-scroll style="background-image:url(assets/images/portfolio/project_01/karsten-winegeart-8RYgfbiTSVU-unsplash.jpg)">
													<img src="assets/images/portfolio/project_01/karsten-winegeart-8RYgfbiTSVU-unsplash.jpg" alt="Project">
												</div>
											</div>
										</div><!-- project img end -->
										...
										<div class="padding-top-bottom-20 pos-rel scrollanim-activate line-scrollanim-activate" data-scroll data-scroll-offset="30%">
											<div class="anim-fade-to-left d-block">
												<h3 class="headline-xxxs">Champion Training</h3>
												<div class="d-flex flex-wrap flex-justify-between margin-top-10">
													<span class="subhead-xxs subhead-uppercase margin-top-10">Photoshoot</span>
													<span class="subhead-xxs subhead-uppercase margin-top-10">2020</span>
												</div>
								...
								<!-- grid-item start -->
								<div class="padding-top-90 grid-item-33-50-100 js-isotope-grid-item">
									<a href="project_06.php" class="grid-margin-box d-block js-pointer-large js-animsition-link" data-scroll data-scroll-speed="1.1">
										<!-- project img start -->
										<div class="hidden-box">
											<div data-scroll data-scroll-speed="-1.3">
										...
										<div class="padding-top-bottom-20 pos-rel scrollanim-activate line-scrollanim-activate" data-scroll data-scroll-offset="30%">
											<div class="anim-fade-to-left d-block">
												<h3 class="headline-xxxs">Sneakers</h3>
												<div class="d-flex flex-wrap flex-justify-between margin-top-10">
													<span class="subhead-xxs subhead-uppercase margin-top-10">Marketing</span>
													<span class="subhead-xxs subhead-uppercase margin-top-10">2020</span>
												</div>
											</div>
											<div class="anim-line-bottom"></div>
								...
								<div class="padding-top-90 grid-item-33-50-100 js-isotope-grid-item">
									<a href="project_03.php" class="grid-margin-box d-block js-pointer-large js-animsition-link">
										...
										<div class="padding-top-bottom-20 pos-rel scrollanim-activate line-scrollanim-activate" data-scroll data-scroll-offset="30%">
											<div class="anim-fade-to-left d-block">
												<h3 class="headline-xxxs">Matreshka Dolls</h3>
												<div class="d-flex flex-wrap flex-justify-between margin-top-10">
													<span class="subhead-xxs subhead-uppercase margin-top-10">Product design</span>
													<span class="subhead-xxs subhead-uppercase margin-top-10">2020</span>
												</div>
											</div>
											<div class="anim-line-bottom"></div>
								...
								<div class="padding-top-90 grid-item-33-50-100 js-isotope-grid-item">
									<a href="project_04.php" class="grid-margin-box d-block js-pointer-large js-animsition-link" data-scroll data-scroll-speed="1">
										...
										<div class="hidden-box">
											<div data-scroll data-scroll-speed="-1.3">
												<div class="anim-img-reveal" data-scroll style="background-image:url(assets/images/portfolio/project_04/keiyamada-3.jpg)">
													<img src="assets/images/portfolio/project_04/keiyamada-3.jpg" alt="Project">
												</div>
											</div>
										</div><!-- project img end -->
										...
										<div class="padding-top-bottom-20 pos-rel scrollanim-activate line-scrollanim-activate" data-scroll data-scroll-offset="30%">
											<div class="anim-fade-to-left d-block">
												<h3 class="headline-xxxs">Kei Yamada</h3>
												<div class="d-flex flex-wrap flex-justify-between margin-top-10">
													<span class="subhead-xxs subhead-uppercase margin-top-10">Photoshoot</span>
													<span class="subhead-xxs subhead-uppercase margin-top-10">2020</span>
												</div>
								...
								<!-- grid-item start -->
								<div class="padding-top-90 grid-item-33-50-100 js-isotope-grid-item">
									<a href="project_05.php" class="grid-margin-box d-block js-pointer-large js-animsition-link" data-scroll data-scroll-speed="0.3">
										<!-- project img start -->
										<div class="hidden-box">
											<div data-scroll data-scroll-speed="-1.3">
												<div class="anim-img-reveal" data-scroll style="background-image:url(assets/images/portfolio/project_05/curology-sR1oAhAT_Uw-unsplash.jpg)">
													<img src="assets/images/portfolio/project_05/curology-sR1oAhAT_Uw-unsplash.jpg" alt="Project">
												</div>
											</div>
										</div><!-- project img end -->
										...
										<div class="padding-top-bottom-20 pos-rel scrollanim-activate line-scrollanim-activate" data-scroll data-scroll-offset="30%">
											<div class="anim-fade-to-left d-block">
												<h3 class="headline-xxxs">Curology</h3>
												<div class="d-flex flex-wrap flex-justify-between margin-top-10">
													<span class="subhead-xxs subhead-uppercase margin-top-10">Branding</span>
													<span class="subhead-xxs subhead-uppercase margin-top-10">2020</span>
												</div>
											</div>
											<div class="anim-line-bottom"></div>
								...
								<!-- grid-item start -->
								<div class="padding-top-90 grid-item-33-50-100 js-isotope-grid-item">
									<a href="project_07.php" class="grid-margin-box d-block js-pointer-large js-animsition-link" data-scroll data-scroll-speed="0.8">
										<!-- project img start -->
										<div class="hidden-box">
											<div data-scroll data-scroll-speed="-1.3">
												<div class="anim-img-reveal" data-scroll style="background-image:url(assets/images/portfolio/project_07/black-bike-2.jpg)">
													<img src="assets/images/portfolio/project_07/black-bike-2.jpg" alt="Project">
												</div>
											</div>
										</div><!-- project img end -->
										...
										<div class="padding-top-bottom-20 pos-rel scrollanim-activate line-scrollanim-activate" data-scroll data-scroll-offset="30%">
											<div class="anim-fade-to-left d-block">
												<h3 class="headline-xxxs">Black Bike</h3>
												<div class="d-flex flex-wrap flex-justify-between margin-top-10">
													<span class="subhead-xxs subhead-uppercase margin-top-10">Photoshoot</span>
													<span class="subhead-xxs subhead-uppercase margin-top-10">2020</span>
												</div>
				...
				<!-- footer start -->
				<footer class="section-bg-light" data-scroll-section>
					<!-- container start -->
					<div class="container padding-top-bottom-30" data-scroll data-scroll-speed="-4" data-scroll-position="bottom">
						...
						<div class="flex-container flex-align-center">
							...
							<div class="eight-columns padding-top-90">
								<h4 class="column-l-r-margin-10 headline-s text-color-black headline-uppercase">
									The Best<br>
									Agency for<br>
									Your Businnes
								</h4>
						...
						<div class="flex-container padding-top-30">
							...
							<div class="four-columns padding-top-60">
								<div class="column-l-r-margin-10">
									<div class="headline-xxxxs text-color-black">Email:</div>
									<div class="margin-top-20">
										<a href="#" class="line-btn black js-pointer-small">mayankpaunikar@gmail.com</a>
										<div class="margin-top-5">
											<a href="#" class="line-btn black js-pointer-small">paunikarmayank@gmail.com</a>
										</div>
									</div>
								</div>
							</div><!-- column end -->
							...
							<div class="four-columns padding-top-60">
								<div class="column-l-r-margin-10">
									<div class="headline-xxxxs text-color-black">Phone:</div>
									<div class="margin-top-20">
										<a href="#" class="subhead-xxs text-color-6d6d6d text-hover-to-black js-pointer-small">+918154064289</a>
										<div class="margin-top-5">
											<a href="#" class="subhead-xxs text-color-6d6d6d text-hover-to-black js-pointer-small">+917990456629</a>
										</div>
									</div>
								</div>
							</div><!-- column end -->
							...
							<div class="four-columns padding-top-60">
								<div class="column-l-r-margin-10">
									<div class="headline-xxxxs text-color-black">Address:</div>
									<div class="margin-top-20">
										<a href="#" class="subhead-xxs text-color-6d6d6d text-hover-to-black js-pointer-small">
							...
							<div class="twelve-columns padding-top-90">
								<div class="column-l-r-margin-10 padding-top-30 pos-rel">
									<div class="anim-line-top black" data-scroll data-scroll-offset="5%"></div>
									<!-- footer-social start -->
									<ul class="list list_row list_margin-30px">
										...
										<li class="list__item">
											<a href="#" class="flip-btn black js-pointer-small" data-splitting>Dribbble</a>
										</li>
										<li class="list__item">
							...
							<div class="twelve-columns padding-top-120">
								<div class="column-l-r-margin-10 pos-rel">
									<p class="copyright margin-right-30 text-color-black">
										&copy; Copyright 2020 TUMAR. Template by <a href="#" class="copyright__author js-pointer-small">Jinna Gik</a>
									</p>
									<!-- to top btn start -->
									<a href="#up" class="scroll-to-btn black js-pointer-large" data-scroll data-scroll-repeat data-scroll-to>
